...
def get_source_location(point_number: int, data_file_number: int):
    ...
    data_place = {
        'office':   r"C:\Users\kazak.ke\PycharmProjects\Quotes_Catalog",
        'home':     r"F:\Kazak\GoogleDrive\1_KK\Job_CNAC\1_targets\SRC\11-09-2023\output_1"
    }
    source_data = {
        1: {"file_name": r"Статистика_1_13_Оборудование_output.xlsx", "sheet_name": "Tables"},
        2: {"file_name": r"Статистика_1_13_Ресурсы_output.xlsx", "sheet_name": "Tables"}
    }
...
if __name__ == "__main__":
    ...
    path, file, sheet = get_source_location(point_number=1, data_file_number=2)
