...
from layout import write_resources_report_excel
...
def get_source_location(point_number: int, data_file_number: int):
    ...
    return data_place[location[point_number]], r"Статистика_1_13 Ресурсы_output.xlsx"


if __name__ == "__main__":

    path, file = get_source_location(point_number=1, data_file_number=1)
    ...
    write_resources_report_excel(input_file, output_file)
